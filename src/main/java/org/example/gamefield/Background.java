...
public class Background {
    ...
    private final Image GAME_BACKGROUND = new ImageIcon(Objects.requireNonNull(GameFrame.class.getResource("/background/guntime_mission_background.png"))).getImage();
